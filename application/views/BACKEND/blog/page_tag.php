                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <a href="<?php echo base_url('blog/edit/').$key['BlogID']?>" class="btn btn-sm btn-warning"><span class="glyphicon fa fa-edit" aria-hidden="true"></span></a>
                                            |
...
<div class="modal fade bd-example-modal-lg" id="modal-add" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <?php echo form_open('blog_controller/store_tags'); ?>
