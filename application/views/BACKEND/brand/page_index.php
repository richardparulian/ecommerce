                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php 
                                            if ($key['BrandStatus'] == 1) {
                                                echo "Show";
                                            }else{echo "Hide";}
                                             ;?></td>
                                            <td style="width: 120px">
                                            <a href="<?php echo base_url('brand-admin/edit/').$key['BrandID']?>" class="btn btn-sm btn-warning"><span class="glyphicon fa fa-edit" aria-hidden="true"></span></a>
                                            |
                                            <a href="<?php echo base_url('Brand_controller/delete/').$key['BrandID']?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure for delete this?')" ><span class="glyphicon fa fa-trash" aria-hidden="true"></span></a>
...
<div class="modal fade bd-example-modal-lg" id="modal-add" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <?php echo form_open('Brand_controller/store'); ?>
                <div class="modal-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Brand</label>
                                <input id="customername" type="text" class="form-control" value="" name="brand"
