...
$config['csrf_token_name'] = 'CSRF_R_TOKEN';
$config['csrf_cookie_name'] = 'CSRF_R_TOKEN';
...
|
*/
$config['app_key'] = 'GKUx9PC5bg51wyv0EIV5qajV5bTSYR83';
